...
const SignupPage = () => {
  ...
  return (
    <div className='min-h-[90vh] bg-mine-shaft-950 font-["poppins"] overflow-hidden'>
      <div
        className={`w-[100vw] h-[100vh] transition-all ease-in-out duration-700 flex [&>*]:flex-shrink-0 ${
      ...
      >
        ...
        <div
          className={`w-1/2 h-full bg-mine-shaft-900 transition-all ease-in-out duration-700 ${
        ...
        >
          ...
          <div className="text-3xl font-semibold text-mine-shaft-100">
